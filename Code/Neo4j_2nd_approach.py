...
# Example usage
neo4j_uri = "bolt://localhost:7687/db/SAMPLE"  # Update with your Neo4j server URI
...
query2 = f"""match (t1:TRACK {{track_name: '{user_input}'}}) -[r:IS_SIMILAR]-> (t2:TRACK) 
return t2.track_name as recommendedTrack, r.similarity as similarity
order by r.rank ASC
limit 5"""
# Run the query
result_data = run_query(neo4j_uri, neo4j_username, neo4j_password, query2)
